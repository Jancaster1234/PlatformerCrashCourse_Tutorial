...
namespace SlimUI.ModernMenu{
	public class UIMenuManager : MonoBehaviour {
        ...
        [Tooltip("The UI Panel that holds the HIGH SCRORE window tab")]
        ...
        [Tooltip("Highlight Image for when HIGH SCORE Tab is selected in Settings")]
        public GameObject lineHighScore;
        ...
        public void LoadContinue()
        {
            ...
            LoadScene("Demo1"); // or the appropriate scene name
        }
